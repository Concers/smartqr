...
export const qrService = {
  ...
  updateDestination: async (id: string, destinationUrl: string, activeFrom?: string, isActive?: boolean) =>
    api.put(`/qr/${id}/destination`, { destinationUrl, activeFrom, isActive }),
